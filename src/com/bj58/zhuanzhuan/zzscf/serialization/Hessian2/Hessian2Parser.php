 ...
 */
namespace com\bj58\zhuanzhuan\zzscf\serialization\Hessian2;

use com\bj58\zhuanzhuan\zzscf\serialization\HessianClassDef;
use com\bj58\zhuanzhuan\zzscf\serialization\HessianIgnoreCode;
use com\bj58\zhuanzhuan\zzscf\serialization\HessianParsingException;
use com\bj58\zhuanzhuan\zzscf\serialization\HessianRef;
use com\bj58\zhuanzhuan\zzscf\serialization\HessianReferenceMap;
use com\bj58\zhuanzhuan\zzscf\serialization\HessianTypeMap;
use com\bj58\zhuanzhuan\zzscf\serialization\HessianUtils;
...
//        foreach (array_keys($options->typeMap) as $key) {
//            echo $key;
//            print "\n";
//            echo $options->typeMap[$key];
//        }
        $this->typemap = new HessianTypeMap($options->typeMap);
		$this->stream = $stream;
	...
	function fillMap($index){
		...
		foreach($classdef->props as $prop){
			...
			if ($obj instanceof \stdClass){
                ...
                $reflection = $this->objectFactory->getObjectReflectionClass($localType);
